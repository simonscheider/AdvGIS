    ...
    def replaceall(self, script = "MOT_C1.flg"):
        ...
        while line:
            if ( script =="MOT_C2a.flg" ):
                ...
                line = line.replace(r'C:\Users\simon\Documents\GitHub\AdvGIS\MY_ROADS.006',r'C:\Users\schei008\OneDrive - Universiteit Utrecht\Documents\GitHub\AdvGIS\MY_ROADS.006')
...
def xls_to_csv(workbook='data.xlsx'):

    # Create output CSV filename
    csv_filename = os.path.splitext(workbook)[0] + '.csv'
    # Write CSV
    with open(csv_filename, 'w', newline='', encoding='utf-8') as csvfile:
        writer = csv.writer(csvfile, quoting=csv.QUOTE_MINIMAL)
        extension = os.path.splitext(workbook)[1].lower()
        # Load workbook
        if extension == ".xlsx":
            ...
            ws = x.sheet_by_index(0)
            for row in range(ws.nrows):
                writer.writerow(ws.row_values(row))
        else:
...
def main():
    ...
    # d = dataf(spath='C:\AdvGIS\Group11', file='MOT11.csv', exit1 = "EMMEN02", exit2= "VLEDDERVEEN")
    ...
    xls_to_csv(workbook="C:\AdvGIS\Group15\MOT15.xlsx")
    ...
    # d = dataf(spath='C:\AdvGIS\Group23', file='MOT23.csv', exit1 = "EXIT_OLDEOUWER01", exit2= "EXIT_OLDEHOLTWOLDE02")
