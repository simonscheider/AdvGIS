...
def main():
    ...
    # d = dataf(spath='C:\AdvGIS\Group08', file='MOT08.csv', exit1 = "TUK", exit2= "BANT02")
    ...
    # d = dataf(spath='C:\AdvGIS\Group10', file='MOT10.csv', exit1 = "REDUZUM01", exit2= "NYEAGE02")
    ...
    # d = dataf(spath='C:\AdvGIS\Group21', file='MOT21.csv', exit1 = "STEENWIJK01", exit2= "SPiER02")
